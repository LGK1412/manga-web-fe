...
import { Menu, BookOpen, Users, Megaphone, FileWarning, Settings, BarChart3, X, Tags, Palette, Shield } from "lucide-react"
                  ...
                  <li key={item.id}>
                    <Link
                      ...
                      className={`flex items-center ${
                        sidebarOpen ? "space-x-3 px-3 justify-start" : "justify-center"
                    ...
                    >
                      <Icon
                        className={`${sidebarOpen ? "h-5 w-5" : "h-6 w-6"} shrink-0`}
                      />
