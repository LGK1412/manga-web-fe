...
const recentUsers = [
  { id: 1, name: "Nguyễn Văn A", email: "nguyenvana@email.com", joinDate: "2024-01-15", role: "User" },
  { id: 2, name: "Trần Thị B", email: "tranthib@email.com", joinDate: "2024-01-14", role: "Author" },
  { id: 3, name: "Lê Văn C", email: "levanc@email.com", joinDate: "2024-01-13", role: "User" },
  { id: 4, name: "Phạm Thị D", email: "phamthid@email.com", joinDate: "2024-01-12", role: "User" },
  { id: 5, name: "Hoàng Văn E", email: "hoangvane@email.com", joinDate: "2024-01-11", role: "Author" },
]

const topStories = [
  { id: 1, title: "One Piece", views: 15420, author: "Oda Eiichiro", status: "Ongoing" },
  { id: 2, title: "Naruto", views: 12350, author: "Kishimoto Masashi", status: "Completed" },
  { id: 3, title: "Attack on Titan", views: 11200, author: "Hajime Isayama", status: "Completed" },
  { id: 4, title: "Demon Slayer", views: 9800, author: "Koyoharu Gotouge", status: "Completed" },
  { id: 5, title: "My Hero Academia", views: 8900, author: "Kohei Horikoshi", status: "Ongoing" },
]
